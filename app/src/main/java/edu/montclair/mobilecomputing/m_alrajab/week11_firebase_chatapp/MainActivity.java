package edu.montclair.mobilecomputing.m_alrajab.week11_firebase_chatapp;
...
import edu.montclair.mobilecomputing.m_alrajab.week11_firebase_chatapp.model.ChatMessageItem;
import edu.montclair.mobilecomputing.m_alrajab.week11_firebase_chatapp.model.ChatMsgAdapter;
...
if(firebaseAuth.getCurrentUser()!=null){
    ...
    Toast.makeText(MainActivity.this, "You are alreaedy signed in",
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
...

        {
            ...
            StorageReference storageReference=mStorageReference.child(uri.getLastPathSegment());

            Log.i(">>","Before Listnr");
            storageReference = FirebaseStorage.getInstance().getReference()
                    .child("images_chat_MA").child(uri.getLastPathSegment());
            ...
            storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    myRef.push().setValue(new ChatMessageItem(null,
                            username, getCurrentTime(), taskSnapshot.getDownloadUrl().toString()));
